...
// Tekst van de artikel beoordelingen in sideboxes/reviews.php
  ...
  define('BOX_REVIEWS_NO_REVIEWS', 'Nog geen recensie\'s. Schrijf als eerste een recensie!');
  define('BOX_REVIEWS_TEXT_OF_5_STARS', '%s van de 5 sterren!');
...
// javascript berichten
  ...
  define('ENTRY_DATE_OF_BIRTH_ERROR', 'U moet uw geboortedatum alsvolgt invullen: DD/MM/JJJJ (bijv. 22/05/1980)');
  define('ENTRY_DATE_OF_BIRTH_TEXT', '* (bijv. 22/05/1980)');
  ...
  define('ENTRY_COUNTRY_ERROR', 'U moet uw land kiezen uit het rolmenu.');
  ...
  define('ENTRY_PASSWORD_CURRENT_ERROR', 'Voor wachtwoord moet u minimaal ' . ENTRY_PASSWORD_MIN_LENGTH . ' tekens invoeren.');
  ...
  define('PREVNEXT_TITLE_FIRST_PAGE', 'pagina 1');
  ...
  define('WARNING_INSTALL_DIRECTORY_EXISTS', 'LET OP: Installatiefolder bestaat: %s. Verwijder deze folder ivm de veiligheid van uw webwinkel!');
...
// betalingsmethode is waardebon/korting
  ...
  define('PAYMENT_MODULE_GV', 'Waardebon/actie');
...
// ipadres
  define('TEXT_YOUR_IP_ADDRESS','Uw ipadres is: ');

// algemene adreskop
  define('HEADING_ADDRESS_INFORMATION','Adres informatie');

// inhoud winkelwagentje
  define('PRODUCTS_ORDER_QTY_TEXT_IN_CART','Aantal in winkelwagentje: ');
  define('PRODUCTS_ORDER_QTY_TEXT','In winkelwagentje: ');

// bericht na succesvol toevoegen aan winkelwagentje als het winkelwagentje ingesteld staat op niet weergeven
// niks invullen voor geen berichten
// geld voor alle paginas behalve daar waar meerdere artikelen in winkelwagentje plaatsen aanstaat :
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Gekozen artikel is in uw winkelwagen geplaatst...');
// alleen voor meerdere artikelen in winkelwagentje plaatsen:
...
// iii 031104 toegevoegd:  Foutmelding voor uploaden bestanden
  ...
  define('WARNING_NO_FILE_UPLOADED', 'Letop:  geen bestand geupload.');
...
// Einde iii toegevoegd
  ...
  define('TEXT_BEFORE_DOWN_FOR_MAINTENANCE', 'LETOP: In verband met gepland onderhoud zal deze site niet bereikbaar zijn op: ');
  define('TEXT_ADMIN_DOWN_FOR_MAINTENANCE', 'LETOP: Onze site is ivm gepland onderhoud niet beschikbaar, wij zien u graag spoedig terug!');
...
// weergave artikelen
  ...
  define('PRODUCTS_QUANTITY_IN_CART_LISTING','In winkelwagentje:');
  ...
  define('ERROR_MAXIMUM_QTY','Maximum toegevoegd - Maximum aantal aan winkelwagentje toegevoegd ');
...
// Downloadmanager
  define('DOWNLOADS_CONTROLLER_ON_HOLD_MSG','LETOP: Downloads zijn pas beschikbaar nadat de betaling is ontvangen en gecontroleerd');
  define('TEXT_FILESIZE_BYTES', ' bytes');
  define('TEXT_FILESIZE_MEGS', ' MB');

// fouten winkelwagentje
  define('ERROR_PRODUCT','Artikel: ');
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART','<br />Helaas is dit artikel momenteel niet leverbaar.<br />Het artikel is uit uw winkelwagentje verwijderd.');
  ...
  define('WARNING_SHOPPING_CART_COMBINED', 'NB: Voor uw gemak hebben wij de inhoud van het winkelwagentje van uw laatste bezoek alvast toegevoegd aan uw huidige winkelwagentje. Controleer de inhoud van uw winkelwagentje alvorens af te rekenen.');
...
// fout tijdens betalingverwerking $_SESSION['customers_id' komt niet voor in de tabel customers
  ...
  define('TABLE_HEADING_DATE_EXPECTED', 'Levertijd');
  ...
  define('SUMMARY_TABLE_UPCOMING_PRODUCTS','in deze lijst ziet u producten die binnenkort weer vooradig zijn en de verwachte datum van beschikbaarheid.');
...
// instellingen t.b.v. prijsweergave na inloggen
  ...
  define('TEXT_LOGIN_FOR_PRICE_BUTTON_REPLACE','Aanmelden om prijs weertegeven');
...
// Verzendkosten calculator
  ...
  define('EMPTY_CART_TEXT_NO_QUOTE', 'Whoops! Uw sessie is verlopen... Om uw verzendkosten te berekenen moet u eerst uw wagentje verversen...');
  define('CART_SHIPPING_QUOTE_CRITERIA', 'Verzendkosten zijn gebaseerd op het door u geselecteerde adres:');

// meerdere artikelen toevoegen aan wagentje
...
// aanmaken account - login
  ...
  define('TEXT_PRIVACY_CONDITIONS_DESCRIPTION', 'Vóór het verzenden van de bestelling moet u akkoord gaan met onze privacyverklaring door het desbetreffende selectievakje in te schakelen. Onze privacy verklaring kunt u <a href="' . zen_href_link(FILENAME_PRIVACY, '', 'SSL') . '"><span class="pseudolink">hier [klik]</span></a> lezen.');
...
// Cookie control
  define ('COOKIE_CONTROL_INTROTEXT', 'Wij gebruiken cookies om u te herkennen bij een volgend bezoek. Verder gebruiken wij Google Analytics.');
  define ('COOKIE_CONTROL_FULLTEXT', 'Cookies stellen ons in staat om informatie te verzamelen over het gebruik van onze diensten en deze te verbeteren en aan te passen aan de wensen van onze bezoekers. Onze cookies geven informatie met betrekking tot persoonsidentificatie. Tevens worden ze gebruikt om uw order correct af te handelen.</p><p>Door onze site te gebruiken gaat u akkoord met onze');
  define ('COOKIE_CONTROL_READ_MORE', 'Lees meer');
  define ('COOKIE_CONTROL_READ_LESS', 'Verkleinen');
  define ('COOKIE_CONTROL_COOKIES_ON', 'Cookies toestaan');
  define ('COOKIE_CONTROL_COOKIES_OFF', 'Cookies niet toestaan');
  define ('COOKIE_CONTROL_ONE_COOKIE', 'Er wordt één cookie wegeschreven om uw voorkeur op te slaan');
  define ('COOKIE_CONTROL_CHECK', 'Niet nogmaals vragen');
  define ('COOKIE_CONTROL_CHECK_EXPLAIN', 'Door dit aan te vinken wordt er een cookie wegeschreven om deze popup te verbergen zodra u op sluiten drukt. Er word géén persoonlijke informatie opgeslagen');
